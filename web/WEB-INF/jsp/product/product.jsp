    ...
    <div class="container">
        <div class="introduction">
            ...
            <p>
                ...
                <br/>
                类别：
                <a href="category?category=${sessionScope.category.fatherId}">
                    <span class="label label-warning">${sessionScope.category.fatherName}</span>
                </a>
                &gt;
                <a href="productList?category2=${sessionScope.category.categoryId}">
                    <span class="label label-warning">${sessionScope.category.categoryName}</span>
                </a>
                <br />
                简介：${sessionScope.product.description}
            </p>
            <button><a href="addShoppingCar">加入购物车</a></button>
            <button><a href="addBillByProduct">直接购买</a></button>
        </div>
    </div>
    <!--container-->
</div>
